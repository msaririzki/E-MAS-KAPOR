    ...
    @if($status === 'pending')
        <div class="transfer-toolbar">
            ...
            <div>
                ...
                <button type="submit" name="action" value="approve_all" formaction="{{ route('admin.personnel.transfer-requests.approve-all') }}" class="approve-all" onclick="return confirm('Setujui semua pengajuan mutasi yang sedang menunggu?');"><i class="ri-check-double-line"></i>Setujui Semua</button>
            </div>
        </div>
    @endif
...
.transfer-toolbar button.approve-all{background:#166534;border-color:#166534;color:#fff}
</style>
@endsection
