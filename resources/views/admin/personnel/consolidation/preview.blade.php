...
<div class="preview-header">
    ...
    <div class="preview-actions">
        ...
        <button
            ...
            title="{{ $hasBlockingErrors ? 'Perbaiki semua baris bermasalah sebelum menyimpan' : 'Simpan data konsolidasi' }}"
        >
