...
class SatkerSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $satkerPolda = [
            ...
            ['name' => 'DIT RES PPA DAN PPO', 'code' => 'RESPPAPPO', 'parent_id' => $polda->id, 'sort_order' => 16],
            ['name' => 'DIT RESNARKOBA', 'code' => 'NARKOBA', 'parent_id' => $polda->id, 'sort_order' => 17],
            ['name' => 'BID PROPAM', 'code' => 'PROPAM', 'parent_id' => $polda->id, 'sort_order' => 18],
            ['name' => 'BID KUM', 'code' => 'KUM', 'parent_id' => $polda->id, 'sort_order' => 19],
            ['name' => 'BID HUMAS', 'code' => 'HUMAS', 'parent_id' => $polda->id, 'sort_order' => 20],
            ['name' => 'BID DOKKES', 'code' => 'DOKKES', 'parent_id' => $polda->id, 'sort_order' => 21],
            ['name' => 'BID TIK', 'code' => 'TIK', 'parent_id' => $polda->id, 'sort_order' => 22],
            ['name' => 'BID KEU', 'code' => 'KEU', 'parent_id' => $polda->id, 'sort_order' => 23],
            ['name' => 'YANMA', 'code' => 'YANMA', 'parent_id' => $polda->id, 'sort_order' => 24],
            ['name' => 'SPRIPIM', 'code' => 'SPRIPIM', 'parent_id' => $polda->id, 'sort_order' => 25],
            ['name' => 'SPN', 'code' => 'SPN', 'parent_id' => $polda->id, 'sort_order' => 26],
            ['name' => 'SETUM', 'code' => 'SETUM', 'parent_id' => $polda->id, 'sort_order' => 27],
            ['name' => 'RUMKIT', 'code' => 'RUMKIT', 'parent_id' => $polda->id, 'sort_order' => 28],
            ['name' => 'SPKT', 'code' => 'SPKT-POLDA', 'parent_id' => $polda->id, 'sort_order' => 29],
            ['name' => 'SISWA', 'code' => 'SISWA', 'parent_id' => $polda->id, 'sort_order' => 30],
        ];
