...
class BudgetYearSatkerDetailSheet implements FromArray, WithEvents, WithTitle
{
    private array $rows = [];
    ...
    public function __construct(
        private readonly BudgetYear $budgetYear,
    ...
    private function buildData(): void
    {
        ...
        $this->rows[] = ['T.A. '.$this->budgetYear->year.' SATKER '.strtoupper($this->satker->name)];
        $this->rows[] = [''];
        $this->rows[] = [
            'NO',
            'NAMA',
        ...
        $personnelRows = app(PackageSatkerAllocationService::class)
            ->buildRowsForBudgetYearPackages($this->budgetYear->packages, $this->satker);
